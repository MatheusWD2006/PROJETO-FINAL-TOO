...
from classificacao_enum import ClassificacaoCultura
from tipocultura_enum import TipoCultura

class Cultura(ABC):
    def __init__(self, nome: str, nome_cientifico: str, descricao: str,
    ...
    def __str__(self):
        return (
            f"Nome: {self.__nome}\n"
            f"Nome Científico: {self.___nome_cientifico}\n"
